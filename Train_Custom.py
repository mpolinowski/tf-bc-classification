...
MCName = os.path.sep.join([config.OUTPUT_PATH, "custom_weights.hdf5"])
...
## load latest weights
path1 = config.OUTPUT_PATH + '/custom_weights.hdf5'
...
# Plotting the graph
training_plot(MF, config.EPOCHS, config.PLOT_PATH_CM)
